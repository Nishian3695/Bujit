...
public class TutorialManager {
    ...
    public static final StepDef[] STEPS = {
        ...
        new StepDef(SettingsActivity.class, R.id.row_categories,
            ...
            8),
        new StepDef(SettingsActivity.class, R.id.row_import_csv,
            "Import from CSV",
            "If you have a CSV of your expenses, you can import it here instead of typing out your information one-by-one. See the in-app reference for details on the required format.",
            8),
